...
export default function TeamForm({
  ...
  return (
    <form
      ...
      className="flex flex-col gap-8 rounded-[28px] border border-white/40 bg-white/75 p-8 shadow-xl backdrop-blur"
    >
      ...
      <div className="flex flex-wrap items-center justify-end gap-3">
        ...
        <button
          ...
          className="inline-flex items-center rounded-full bg-[#1B1533] px-6 py-2.5 text-sm font-semibold text-white hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 transition disabled:cursor-not-allowed disabled:opacity-50"
        >
          {submitLabel}
        </button>
      </div>
