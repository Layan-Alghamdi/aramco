      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="inline-flex items-center rounded-full bg-[#1B1533] px-4 py-2 text-sm font-semibold text-white hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 transition"
          >
            Upload
          </button>
          {value && (
