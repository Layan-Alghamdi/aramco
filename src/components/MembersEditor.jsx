    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={handleAdd}
          className="glow-btn inline-flex items-center rounded-full border border-[#D1D5DB] bg-white px-4 py-2 text-xs font-semibold text-[#1B1533] hover:bg-[#F9FAFB] focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 transition"
        >
          Add another
        </button>
      </div>
              ...
              <div className="flex items-end justify-end">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="glow-btn inline-flex items-center rounded-full border border-[#E5E7EB] px-3 py-1 text-xs font-semibold text-[#6B7280] hover:bg-[#F3F4F6] focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 transition disabled:opacity-50"
