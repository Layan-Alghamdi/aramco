...
export default function Profile() {
  ...
  const settings = [
    { label: "Change Password", onClick: handleChangePassword, tone: "primary" },
    { label: "Notification Preferences", onClick: handleNotificationPreferences, tone: "neutral" },
    { label: `Theme: ${themeLabel}`, onClick: openThemeModal, tone: "neutral" },
    { label: "Log Out", onClick: handleLogout, tone: "danger" }
  ];
      ...
      {isThemeModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-6">
          ...
          <div
            ...
            className="relative z-10 w-full max-w-[420px] rounded-[28px] border border-white/60 bg-white/95 px-8 py-8 shadow-[0_24px_60px_rgba(15,23,42,0.2)] transition-transform duration-200 ease-out"
          >
            <div className="flex items-start justify-between pb-4">
              <div>
                <h2 id="theme-selector-title" className="text-2xl font-semibold text-[#111827]">
                  Choose Theme
                </h2>
                <p className="mt-1 text-sm text-[#6B7280]">Select the appearance that works best for you.</p>
              </div>
              <button
                type="button"
                onClick={closeThemeModal}
